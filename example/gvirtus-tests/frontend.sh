...
nvcc test_cudnn.cu -o test -L ${GVIRTUS_HOME}/lib/frontend -L ${GVIRTUS_HOME}/lib/ -L/usr/local/lib -lcuda -lcudart -lcudnn -lcublas -lcufft -lcurand -lgtest -lgtest_main -lpthread
./test
